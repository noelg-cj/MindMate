  ...
  return (
    <form className='bg-[#E3E7ED] border-2 border-[#B3CDEE] rounded-md'>
       <label className='flex'>
            <input type='text' name='Chat' autoComplete='off' placeholder="Tell us how you're feeling today!" className='bg-[#E3E7ED] p-5 w-full focus:outline-[#5E9FF2] rounded-md' /> 
            <div className='p-2'>
